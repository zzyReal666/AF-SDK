...
import com.szaf.constant.CertParseInfoType;
import com.szaf.constant.ConstantNumber;
import com.szaf.constant.ModulusLength;
import com.szaf.crypto.algorithm.sm3.SM3Impl;
...
import com.szaf.struct.impl.RSA.RSAPriKey;
import com.szaf.struct.impl.RSA.RSAPubKey;
import com.szaf.struct.impl.sm2.SM2Cipher;
import com.szaf.struct.impl.sm2.SM2Signature;
import com.szaf.struct.signAndVerify.AFPkcs7DecodeData;
import com.szaf.struct.signAndVerify.AFSM2DecodeSignedData;
import com.szaf.struct.signAndVerify.AFSvCryptoInstance;
import com.szaf.struct.signAndVerify.CertAltNameTrustList;
import com.szaf.struct.signAndVerify.RSA.RSAKeyPairStructure;
import com.szaf.struct.signAndVerify.RSA.RSAPrivateKeyStructure;
import com.szaf.struct.signAndVerify.RSA.RSAPublicKeyStructure;
import com.szaf.struct.signAndVerify.sm2.*;
import com.szaf.utils.BigIntegerUtil;
import com.szaf.utils.BytesBuffer;
import com.szaf.utils.BytesOperate;
import com.szaf.utils.base64.Base64;
import com.szaf.utils.pkcs.AFPkcs1Operate;
...
//        cmd.getPrivateAccess(keyIndex, 3);
     ...
     * @param certInfoType      : 用户待获取的证书内容类型 : 类型定义在类{@link CertParseInfoType}
     * @return ：用户获取到的证书信息内容
     */
     ...
     *
     * @param base64Certificate ：Base64编码的证书文件
     * @param certInfoOid       : 用户待获取的证书内容类型OID值 : OID值定义在类 {@link CertParseInfoType}
     * @return ：用户获取到的证书信息内容
     */
     ...
     * @return RSAPubKey 对象
     */
    private RSAPubKey getRSAPublicKeyFromCertificate(byte[] certificate) throws AFCryptoException {
